                                    ...
                                    <div class="widget-body" style="padding-bottom: 0px">
                                        ...
                                        <div class="tab-pane active" id="hb000">
                                            ...
                                            <div class="table-responsive">
                                                <form id="form" method="POST" >
                                                    <table class="table table-bordered table-striped" style="background-color: #f9f9f9; margin-bottom: 1px;">
                                                        <tbody>                                                            
                                                            <tr>
                                                                <td class="bg-color-blue txt-color-white text-align-right">新增物品</td>
                                                                <td class="input-padding">
                                                                    <input class="form-control input-xs" placeholder="物品序號" type="text" id="itemSerial" name="itemSerial" required="required">
                                                                </td>
                                                                <td class="bg-color-blue txt-color-white  text-align-right">物品種類</td>
                                                                <td class="input-padding">
                                                            ...
                                                            <tr>
                                                                <td class="bg-color-blue txt-color-white text-align-right">廠商</td>
                                                                <td class="input-padding">
                                                                    <select class="form-control input-xs" id="selectVendor" name="selectVendor">
                                                                    </select>
                                                                </td>
                                            ...
                                            <div id="infoBar" class="alert alert-info no-margin fade in">
                                                ...
                                                管理物品 <code>(<span id="rowcount"></span>)</code>
                                            </div>
