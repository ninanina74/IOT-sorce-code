    ...
    <body class="desktop-detected pace-done smart-style-3 fixed-navigation fixed-header fixed-ribbon">
                                    ...
                                    <div class="widget-body" style="padding-bottom: 0px">
                                        ...
                                        <div class="tab-pane active" id="hb000">
                                            ...
                                            <div class="table-responsive">
                                                <form id="form" method="POST" >
                                                    <table class="table table-bordered table-striped" style="background-color: #f9f9f9; margin-bottom: 1px;">
                                                        <tbody>                                                            
                                                            <tr>
                                                                <td class="bg-color-blue txt-color-white text-align-right">新增物品種類</td>
                                                                <td class="input-padding">
                                                                    <input class="form-control input-xs" placeholder="物品種類" type="text" id="itemType" name="itemType" required="required">
                                                                </td>
                                            ...
                                            <div id="infoBar" class="alert alert-info no-margin fade in">
                                                ...
                                                管理物品種類 <code>(<span id="rowcount"></span>)</code>
                                            </div>
        ...
        <script>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            result = result + "<tr>\n";
                            result = result + "<td><div class='col-md-12 text-center'><a class='btn btn-primary btn-sm' onClick='changeItemType(" + i + ")' id='changeBtn" + i + "'>修改</a></div></td>\n";
                            result = result + "<td id='itemTypeId" + i + "'>" + data[i]['type_id'] + "</td>\n";
            ...
            function changeItemType(index)
            {
                $('#infoBar').append("<h1 id='loadingloading' class='ajax-loading-animation'><i class='fa fa-cog fa-spin'></i> Loading...</h1></div>");
                $.ajax({
                    url: "ChangeItemType.php",
                    data: {
                        itemTypeId: $("#itemTypeId" + index).html(),
