...
<html>
    ...
    <body class="desktop-detected pace-done smart-style-3 fixed-navigation fixed-header fixed-ribbon">
                                    ...
                                    <div class="widget-body" style="padding-bottom: 0px">
                                        ...
                                        <div class="tab-pane active" id="hb000">
                                            ...
                                            <div class="table-responsive">
                                                <form id="form" method="POST" >
                                                    <table class="table table-bordered table-striped" style="background-color: #f9f9f9; margin-bottom: 1px;">
                                                        <tbody>                                                            
                                                            <tr>
                                                                <td class="bg-color-blue txt-color-white text-align-right">新增地點</td>
                                                                <td class="input-padding">
                                                                    <input class="form-control input-xs" placeholder="地點名稱" type="text" id="locationName" name="locationName" required="required">
                                                                </td>
                                            ...
                                            <div id="infoBar" class="alert alert-info no-margin fade in">
                                                ...
                                                管理地點 <code>(<span id="rowcount"></span>)</code>
                                            </div>
        ...
        <script>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            result = result + "<tr>\n";
                            result = result + "<td><div class='col-md-12 text-center'><a class='btn btn-primary btn-sm' onClick='changeLocation(" + i + ")' id='changeBtn" + i + "'>修改</a></div></td>\n";
                            result = result + "<td id='location_id" + i + "'>" + data[i]['location_id'] + "</td>\n";
                            result = result + "<td><input class='form-control input-xs' type='text' id='changeLocation" + i + "' name='changeLocation" + i + "' value='" + data[i]['location_name'] + "'></td>\n";   
            ...
            {
                if ($.trim($("#changeLocation" + index).val()) == "") {
                    alert("必須填入地點名稱");
                    return;
                }
                ...
                $.ajax({
                    ...
                    data: {
                        locationId: $("#location_id" + index).html(),
                        changeLocation: $("#changeLocation" + index).val(),
